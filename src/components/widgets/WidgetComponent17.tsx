...
export interface Widget17Props {
  title?: string;
...
export const WidgetComponent17: React.FC<Widget17Props> = ({
  title = 'Analytics Widget #17',
  metricValue = '$' + (12400 + 16 * 850).toLocaleString(),
  changeRate = '+12.4%',
  isPositive = true,
  dataPoints = [42, 73, 34, 72, 71]
}) => {
