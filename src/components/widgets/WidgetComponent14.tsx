...
export interface Widget14Props {
  title?: string;
...
export const WidgetComponent14: React.FC<Widget14Props> = ({
  title = 'Analytics Widget #14',
  metricValue = '$' + (12400 + 13 * 850).toLocaleString(),
  changeRate = '+17.4%',
  isPositive = true,
  dataPoints = [36, 64, 31, 66, 68]
}) => {
