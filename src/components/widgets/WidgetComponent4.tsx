...
export const WidgetComponent4: React.FC<Widget4Props> = ({
  title = 'Analytics Widget #4',
  metricValue = '$' + (12400 + 3 * 850).toLocaleString(),
  changeRate = '+15.4%',
  isPositive = true,
  dataPoints = [16, 34, 21, 46, 58]
}) => {
