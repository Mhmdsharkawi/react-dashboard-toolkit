...
export interface Widget12Props {
  title?: string;
...
export const WidgetComponent12: React.FC<Widget12Props> = ({
  title = 'Analytics Widget #12',
  metricValue = '$' + (12400 + 11 * 850).toLocaleString(),
  changeRate = '+15.4%',
  isPositive = true,
  dataPoints = [32, 58, 29, 62, 66]
}) => {
