...
export interface Widget13Props {
  title?: string;
...
export const WidgetComponent13: React.FC<Widget13Props> = ({
  title = 'Analytics Widget #13',
  metricValue = '$' + (12400 + 12 * 850).toLocaleString(),
  changeRate = '+16.4%',
  isPositive = true,
  dataPoints = [34, 61, 30, 64, 67]
}) => {
