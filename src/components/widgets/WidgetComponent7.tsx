...
export const WidgetComponent7: React.FC<Widget7Props> = ({
  title = 'Analytics Widget #7',
  metricValue = '$' + (12400 + 6 * 850).toLocaleString(),
  changeRate = '+18.4%',
  isPositive = true,
  dataPoints = [22, 43, 24, 52, 61]
}) => {
