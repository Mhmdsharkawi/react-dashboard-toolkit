...
export const WidgetComponent5: React.FC<Widget5Props> = ({
  title = 'Analytics Widget #5',
  metricValue = '$' + (12400 + 4 * 850).toLocaleString(),
  changeRate = '+16.4%',
  isPositive = true,
  dataPoints = [18, 37, 22, 48, 59]
}) => {
