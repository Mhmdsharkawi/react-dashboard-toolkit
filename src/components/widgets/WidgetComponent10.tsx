...
export interface Widget10Props {
  title?: string;
...
export const WidgetComponent10: React.FC<Widget10Props> = ({
  title = 'Analytics Widget #10',
  metricValue = '$' + (12400 + 9 * 850).toLocaleString(),
  changeRate = '+13.4%',
  isPositive = true,
  dataPoints = [28, 52, 27, 58, 64]
}) => {
