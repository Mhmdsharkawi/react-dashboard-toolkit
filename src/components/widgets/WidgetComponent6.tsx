...
export const WidgetComponent6: React.FC<Widget6Props> = ({
  title = 'Analytics Widget #6',
  metricValue = '$' + (12400 + 5 * 850).toLocaleString(),
  changeRate = '+17.4%',
  isPositive = true,
  dataPoints = [20, 40, 23, 50, 60]
}) => {
