...
export const WidgetComponent8: React.FC<Widget8Props> = ({
  title = 'Analytics Widget #8',
  metricValue = '$' + (12400 + 7 * 850).toLocaleString(),
  changeRate = '+19.4%',
  isPositive = true,
  dataPoints = [24, 46, 25, 54, 62]
}) => {
