...
export interface Widget11Props {
  title?: string;
...
export const WidgetComponent11: React.FC<Widget11Props> = ({
  title = 'Analytics Widget #11',
  metricValue = '$' + (12400 + 10 * 850).toLocaleString(),
  changeRate = '+14.4%',
  isPositive = true,
  dataPoints = [30, 55, 28, 60, 65]
}) => {
